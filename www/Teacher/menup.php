            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="academy-cool-facts-area mb-50">
                        ...
                        $sqli = "SELECT count(ID_Stu) AS ID_Stu FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu LEFT JOIN tb_at ON tb_login.ID_Student = tb_at.FK_ID_Student WHERE Branch = '1' AND class = '1' AND room = '1' AND Criterion = '1' ";
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                   ...
                                   <h4>ปวช.1/1</h4>
                                    ...
                                    <a href="pth3L11.php"><button><p>ตรวจสอบ</p></button></a>
                                </div>
                            </div>
<?php    
                        // $sql2="SELECT count(ID_Stu) AS ID_Stu FROM tb_info WHERE    class = '1' AND room = '2'";
                        $sql2 = "SELECT count(ID_Stu) AS ID_Stu FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu LEFT JOIN tb_at ON tb_login.ID_Student = tb_at.FK_ID_Student WHERE Branch = '1' AND class = '1' AND room = '2' AND Criterion = '1' ";
                        ...
                        // $sql3="SELECT  * FROM tb_info WHERE    class = '1' AND room = '3'";
                            $sql2 = "SELECT count(ID_Stu) AS ID_Stu FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu LEFT JOIN tb_at ON tb_login.ID_Student = tb_at.FK_ID_Student WHERE Branch = '1' AND class = '1' AND room = '3' AND Criterion = '1' ";
