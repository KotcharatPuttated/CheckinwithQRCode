...
$sql = "SELECT * FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu LEFT JOIN tb_at ON tb_login.ID_Student = tb_at.FK_ID_Student LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE class = '6' AND Criterion = '1' ORDER BY Date_Check DESC ";
...
<body>
    ...
    <!-- ##### Breadcumb Area End ##### -->
 <section class="elements-area section-padding-0-0">
        <div class="container">
            <div class="row">
