...
//ดึงข้อมูลนักเรียนของห้อง 2 ที่เช็คชื่อแล้วมาโดยเรียงวันที่และเวลาที่เช็คก่อนมาก่อนด้วย DESC
$sql = "SELECT * FROM tb_at LEFT JOIN tb_info ON tb_at.FK_ID_Student = tb_info.ID_Stu WHERE Branch = '1' AND class = '1' AND room = '2' AND Criterion = '1' ORDER BY Date_Check DESC ";
...
//print_r($re);
 ...
 while($row2 = mysqli_fetch_array($re))
    ...
    //echo "mee"."<br/>";
            ...
            // $sqlup1 = "UPDATE tb_count SET day = CONCAT(day,',',".$dated."), count = count+1, mount = '".$datem."' WHERE ID_C_Student = '".$row2['ID_Stu']."' ";
            // $reup1=mysqli_query($conn,$sqlup1);
...
//             $sql1="INSERT INTO tb_info (ID_Stu) VALUES ('$ID')";
// $query1 = mysqli_query($conn,$sql1);


            // echo "<script language=\"JavaScript\">";
            // echo "alert('".$row2['ID_Stu']."');window.location='cth3L12.php';";
            // echo "</script>";
    	}
