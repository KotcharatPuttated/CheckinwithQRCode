            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="academy-cool-facts-area mb-50">
                        <div class="row">
                        <?php    
                        $sqli="SELECT count(ID_Stu) AS ID_Stu FROM tb_info WHERE Branch = '1' AND class = '2' AND room = '1'";
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                   ...
                                   <h4>ปวช.2/1</h4>
                                    ...
                                    <a href="th3L2.1N.php"><button><p>ตรวจสอบ</p></button></a>
                                </div>
                            </div>
<?php    
                        $sql2="SELECT count(ID_Stu) AS ID_Stu FROM tb_info WHERE Branch = '1' AND class = '2' AND room = '2'";
                        ...
                        ?>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                    ...
                                    <a href="th3L2.2N.php"><button><p>ตรวจสอบ</p></button></a>
                                </div>
                            </div>
                            <?php    
                        $sql3="SELECT count(ID_Stu) AS ID_Stu FROM tb_info WHERE Branch = '1' AND class = '2' AND room = '3'";
                        ...
                        ?>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                    ...
                                    <a href="th3L2.3N.php"><button><p>ตรวจสอบ</p></button></a>
                                </div>
                            </div>
