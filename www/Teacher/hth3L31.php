...
// $sql = "SELECT * FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu WHERE Branch = '1' AND class = '3' AND room = '1'";
//   $re = mysqli_query($conn,$sql);


$sql = "SELECT *, SUM(count) AS sumcount FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '3' AND room = '1' GROUP BY ID_C_Student ";
  $re = mysqli_query($conn,$sql);
