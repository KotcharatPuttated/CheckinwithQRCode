...
$sql = "SELECT * FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class LEFT JOIN tb_login ON tb_count.ID_C_Student = tb_login.ID_Student WHERE Branch = '1' AND class = '2' AND room = '3'";
