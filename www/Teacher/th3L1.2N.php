...
$sql = "SELECT *,SUM(count) AS sumcount FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '1' AND room = '2' GROUP BY ID_C_Student ";
$re = mysqli_query($conn, $sql);

$sql1 = "SELECT *,SUM(count) AS sumcount FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE ID_Stu LIKE '%".$_GET['sc']."%' AND Branch = '1' AND class = '1' AND room = '2' GROUP BY ID_C_Student ";
