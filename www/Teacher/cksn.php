...
$sql = "SELECT * FROM tb_at LEFT JOIN tb_info ON tb_at.FK_ID_Student = tb_info.ID_Stu WHERE class = '6' AND Criterion = '1' ORDER BY Date_Check DESC ";
