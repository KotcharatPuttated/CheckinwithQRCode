...
$sql = "SELECT * FROM tb_at LEFT JOIN tb_info ON tb_at.FK_ID_Student = tb_info.ID_Stu WHERE Branch = '1' AND class = '1' AND room = '3' AND Criterion = '1' ORDER BY Date_Check DESC ";
