...
// $sql = "SELECT * FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '1' AND room = '3'";
...
<!-- <p><button> บันทึกผลกิจกรรม </button></p> -->
  ...
  <tr>
   ...
   <tr>
    ...
    <?php echo $row2['sumcount']." สัปดาห์"; ?></td>
    <td style="text-align: center;"><?php if($row2['sumcount'] >= '15' && $row2['sumcount']<= '18' ){ echo "ผ่าน";}else{ echo "ไม่ผ่าน";} ; 
