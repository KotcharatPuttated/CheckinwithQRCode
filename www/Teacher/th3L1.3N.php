...
// $sql = "SELECT * FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class LEFT JOIN tb_login ON tb_count.ID_C_Student = tb_login.ID_Student WHERE Branch = '1' AND class = '1' AND room = '1'";
//   $re = mysqli_query($conn,$sql);
// $sql = "SELECT * FROM tb_info LEFT JOIN tb_count ON tb_info.ID_Stu = tb_count.ID_C_Student LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '1' AND room = '1' GROUP BY ID_C_Student ";

// $sql0 = "SELECT * FROM tb_info LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '1' AND room = '1' GROUP BY ID_Stu ";
// $re0 = mysqli_query($conn, $sql0);


$sql = "SELECT *,SUM(count) AS sumcount FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '1' AND room = '3' GROUP BY ID_C_Student ";
$re = mysqli_query($conn, $sql);

$sql1 = "SELECT *,SUM(count) AS sumcount FROM tb_count LEFT JOIN tb_info ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE ID_Stu LIKE '%".$_GET['sc']."%' AND Branch = '1' AND class = '1' AND room = '3' GROUP BY ID_C_Student ";
...
text-align: center;*/
      ...
      <input name="sc" class="form-control mr-sm-2" type="search" placeholder="Search" aria-label="Search">
                                        ...
                                        <table>
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td> <?php echo $row2['sumcount'] . " สัปดาห์"; ?></td>
                                                    <td style="text-align:center;"><?php if ($row2['sumcount'] >= '15' && $row2['sumcount'] <= '18') {
                                                                                        echo "ผ่าน";
                                                                                    } else {
                                                                                        echo "ไม่ผ่าน";
                                                                                    };
                                            ...
                                            <?php
                                            while ($row3 = mysqli_fetch_array($re1)) {
                                                //     $sql2="SELECT * FROM tb_count WHERE ID_C_Student = '".$row2['ID_Stu']."' "; 
                                                // $result2=mysqli_query($conn,$sql2); 
                                                //  $jan =mysqli_fetch_array($result2);
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row3['ID_Stu']; ?></td>
                                                    <td><?php echo $row3['name']; ?></td>
                                                    <td><?php echo $row3['level'] . "/" . $row3['room']; ?></td>
                                                    <td><?php echo $row3['Phone']; ?></td>
                                                    <td> <?php echo $row3['sumcount'] . " สัปดาห์"; ?></td>
                                                    <td style="text-align:center;"><?php if ($row3['sumcount'] >= '15' && $row3['sumcount'] <= '18') {
                                                                                        echo "ผ่าน";
                                                                                    } else {
                                                                                        echo "ไม่ผ่าน";
                                                                                    };
