...
$select_ed="SELECT * FROM tb_login WHERE ID_Student ='".$_GET['ID']."' ";
  ...
  <div class="card card-primary">
      <div class="card-header">
        <h3 class="card-title">แก้ไขข้อมูล</h3>
              ...
              <!-- /.card-header -->
              <!-- form start -->
      <form role="form" action="../edit2.php?ID=<?php echo $_GET["ID"]; ?>" method="POST">
        <div class="card-body">

      <!-- <input size="100%" type="text" name="User2" value="<?php echo $show_ed['User']?>" disabled="disabled"> -->
        <div class="form-group">
          <label for="exampleInputEmail1">บัญชีผู้ใช้</label>
              <input size="100%" type="text" class="form-control" id="exampleInputID1" name="ID2" value="<?php echo $show_ed['ID_Student']?>" pattern="[A-Z,a-z,0-9]+" required="required">
        </div>
        <div class="form-group">
             <label for="exampleInputEmail1">รหัสผ่าน</label>
             <input size="100%" type="password" class="form-control" id="exampleInputPassword1" name="Password2" value="" pattern="[A-Z,a-z,0-9]+" required="required">
        </div>
      <!-- <br><input size="110" type="text" name="Status2" value="<?php echo $show_ed['Status']?>"> -->
        ...
        <div class="" style="position: relative; top: -50px; left: 100px;">
        <a role="form" href="projects.php?txtsearch="><button type="submit" class="btn btn-primary">ยกเลิก</button></a>
         </div>
