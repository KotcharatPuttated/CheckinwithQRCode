...
$row_pqr=mysqli_fetch_array($qri_pqr);
  ...
  // $re = mysqli_query($conn,$sql);
   ...
   $sql = "SELECT *, SUM(count) AS sumcount FROM tb_info LEFT JOIN tb_count ON tb_info.ID_Stu = tb_count.ID_C_Student LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '1' AND class = '2' GROUP BY ID_C_Student ";
  $re = mysqli_query($conn,$sql);
