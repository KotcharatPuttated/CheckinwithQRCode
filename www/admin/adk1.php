...
include('../security1.php');
  ...
  // $sql = "SELECT * FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu WHERE Branch='5' AND class='4' ";
  // $re = mysqli_query($conn,$sql);

   $sql = "SELECT *, SUM(count) AS sumcount FROM tb_info LEFT JOIN tb_count ON tb_info.ID_Stu = tb_count.ID_C_Student LEFT JOIN tb_class ON tb_info.class = tb_class.ID_Class WHERE Branch = '5' AND class = '4' GROUP BY ID_C_Student ";
  $re = mysqli_query($conn,$sql);
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body table-responsive p-0" style="height: 300px;">
                ...
                {
                    $sql2="SELECT *, SUM(count) AS sumcount FROM tb_info LEFT JOIN tb_count ON tb_count.ID_C_Student = tb_info.ID_Stu LEFT JOIN tb_class ON tb_class.ID_Class = tb_info.class WHERE (ID_Stu LIKE '%".$_GET['table_search']."%' OR name LIKE '%".$_GET['table_search']."%') AND Branch = '5' AND class = '4' GROUP BY ID_C_Student ";
