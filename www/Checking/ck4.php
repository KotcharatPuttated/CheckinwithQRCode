                    ...
                    <div class="accordions mb-100" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="panel single-accordion">
                            ...
                            <div id="collapseOne" class="accordion-content collapse show">
                                <form action="registerck.php" method="POST">
...
<!--    <br>สถานะ : <input type="text" name="Status">
 -->    
            <br><select  class="form-control" type="text" name="Status" required="required" value="Student">
...
<center>
    ...
    <button class="academy-btn btn-4 mt-30" type="reset">ยกเลิก</button>
                        ...
                        <div class="panel single-accordion">
                            <h6>
                                <a role="button" aria-expanded="true" aria-controls="collapseThree" class="collapsed" data-parent="#accordion" data-toggle="collapse" href="#collapseThree">ลบสิทธิ์ครู
                                        <span class="accor-open"><i class="fa fa-plus" aria-hidden="true"></i></span>
                                        <span class="accor-close"><i class="fa fa-minus" aria-hidden="true"></i></span>
                                    </a>
                            </h6>
                            <div id="collapseThree" class="accordion-content collapse">
                               <center><form action="deleteck.php?ID=<?php echo $row_pqr['ID_Student']; ?>" method="POST">
    <br><input type="text" class="form-control" placeholder="ชื่อผู้ใช้" name="ID" pattern="[A-Z,a-z,0-9]+" required="required">
    <!-- <br><input type="password"  class="form-control" placeholder="รหัสผ่าน" name="Password" pattern="[A-Z,a-z,0-9]+" required="required"> -->
<!--    <br>สถานะ : <input type="text" name="Status">
 -->    
