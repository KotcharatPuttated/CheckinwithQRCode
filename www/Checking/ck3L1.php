...
<button class="academy-btn btn-4" style="position: relative; left: 280px; top: -80px;" onclick="window.print()"><img src="../img/555.png"></button>
</div>
...
?>
    ...
    <script type="text/javascript">
      ...
      function drawVisualization() {
        ...
        var options = {
          title : 'ปวช.1/1',
          vAxis: {title: 'จำนวนวันที่เข้า'},
          hAxis: {title: 'รายชื่อนักศึกษา'},
          seriesType: 'bars',
          series: {5: {type: 'line'}}        };
