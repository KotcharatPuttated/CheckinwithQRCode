...
$sql = "SELECT * FROM tb_login LEFT JOIN tb_info ON tb_login.ID_Student = tb_info.ID_Stu  WHERE class = '1' AND room = '2'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                   ...
                                   <h4>ปวช.1/1</h4>
                                    <h3><span class="counter button-btn btn-5">13</span>คน</h3>
                            ...
                            <div class="col-12 col-sm-6 col-md-3">
                                <div class="single-cool-fact text-center">
                                    <!-- <i class="icon-agenda-1"></i> -->
                                    <h4>ปวช.1/2</h4>
                                    <h3><span class="counter button-btn btn-5">10</span>คน</h3>
