...
<body>
  ...
  <body>
<video id="preview" width="300" height="500"></video>
    <script>
...
<body>
    ...
    <div class="select">
    <label for="videoSource">เลือกกล้อง:&nbsp;</label><select id="videoSource"></select>
  </div>

  <div class="select">
    <label for="audioSource">เลือกเสียง:&nbsp;</label><select id="audioSource"></select>
  </div>
